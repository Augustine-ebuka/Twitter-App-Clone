...
include("includes/connection.php");
	...
	//if we have user using thesame name this will generaate a number for each user
	...
	//this password has been hashed so that i cant see someone password
