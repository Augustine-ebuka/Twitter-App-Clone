          ...
          "; ?>
           ...
           <?php 
            ...
            if(isset($_POST['submit'])){
              ...
              //random number so tha user image will not exchange themselves 
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #e6e6e6; text-align: center; left:0.8%; border-radius: 5px;">
		...
		<center><h4><strong>".ucfirst($first_name)." $last_name</strong></h4></center>
	...
	<div class="col-sm-6">
		...
		<?php
			...
			<div id='own_posts'>
				<div class='row'>
					<div class='col-sm-2'>
						<p><img src='users/$user_image' class='img-circle' width='10px' height='100px'></p>
					</div>
					<div class='col-sm-6'>
...
//double  verification of user with that email
			$user = $_SESSION['user_email'];
			$get_user = "select * from users where user_email='$user'"; 
			$run_user = mysqli_query($con,$get_user);
			$row=mysqli_fetch_array($run_user);
